...
def save_checkpoint(state, is_best, filename='/vol/bitbucket/jyk416/OneClassDenseNet/checkpoints_2_25_256/checkpoint.pth.tar'):
...
def train():
    print("started_train")
    directory = '/vol/bitbucket/jyk416/OneClassDenseNet/checkpoints_2_25_256/'
    model_directory = '/vol/bitbucket/jyk416/OneClassDenseNet/models_2_25_256/'
    ...
    model.load_state_dict(torch.load("/vol/bitbucket/jyk416/OneClassDenseNet/models_2_25_256/model46.pth"))
