...
def get_dataloaders():
    transform = transforms.Compose([transforms.Resize(512), transforms.RandomCrop(256), transforms.ToTensor()])
...
def save_checkpoint(state, is_best, filename='/vol/bitbucket/jyk416/OneClassDenseNet/checkpoints_4_25_256/checkpoint.pth.tar'):
...
def train():
    print("started_train")
    directory = '/vol/bitbucket/jyk416/OneClassDenseNet/checkpoints_4_25_256/'
    model_directory = '/vol/bitbucket/jyk416/OneClassDenseNet/models_4_25_256/'
    ...
    model.load_state_dict(torch.load("/vol/bitbucket/jyk416/OneClassDenseNet/models_4_25_256/model98.pth"))
    ...
    #             }, is_best)
    #     if epoch % 5 == 0:
    #         torch.save(model.state_dict(), model_filename.format(epoch + 62 + 1))
    # torch.cuda.empty_cache()
