...
def save_checkpoint(state, is_best, filename='/home/yoon/jyk416/OneClassDenseNet/checkpoints_healthy/checkpoint.pth.tar'):
...
def train():
    print("started_train")
    directory = '/home/yoon/jyk416/OneClassDenseNet/checkpoints_healthy/'
    model_directory = '/home/yoon/jyk416/OneClassDenseNet/healthy_models/'
    ...
    # model.load_state_dict(torch.load("/home/bitbucket/jyk416/OneClassDenseNet/models/model48.pth"))
