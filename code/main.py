...
def train():
    ...
    model.load_state_dict(torch.load("/vol/bitbucket/jyk416/OneClassDenseNet/models_2_50_256/model26.pth"))
    ...
    for epoch in range(num_epoch):
        ...
        if epoch % 5 == 0:
            torch.save(model.state_dict(), model_filename.format(epoch + 26 + 1))
    torch.cuda.empty_cache()
