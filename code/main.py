...
def train():
    print("started_train")
    directory = '/vol/bitbucket/jyk416/OneClassDenseNet/checkpoints_2_25/'
    model_directory = '/vol/bitbucket/jyk416/OneClassDenseNet/models_2_25/'
    ...
    model.load_state_dict(torch.load("../models_2_25/model78.pth"))
